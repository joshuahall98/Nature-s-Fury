...
public class WindMoves : MonoBehaviour
{
    ...
    public void PU1WindMove2Btn()
    {
        ...
        if (playerUnit1.isStunned == false)
        {
            ...
            if (chosenEnemy1.isBlocking == false)
            {
                ...
                dialogueText.text = "Player's " + playerUnit1.unitName + " used Whirling Tornado on the enemy " + chosenEnemy1.unitName + " dealing " + whirlingTornadoBuff + " damage";
    ...
    public void PU2WindMove2Btn()
    {
        ...
        if (playerUnit2.isStunned == false)
        {
            ...
            if (chosenEnemy2.isBlocking == false)
            {
                ...
                chosenEnemy2.TakeDamage(whirlingTornadoBuff);
                ...
                dialogueText.text = "Player's " + playerUnit2.unitName + " used Whirling Tornado on the enemy " + chosenEnemy2.unitName + " dealing " + whirlingTornadoBuff + " damage";
    ...
    public void PU3WindMove2Btn()
    {
        ...
        if (playerUnit3.isStunned == false)
        {
            ...
            if (chosenEnemy3.isBlocking == false)
            {
                ...
                chosenEnemy3.TakeDamage(whirlingTornadoBuff);
                ...
                dialogueText.text = "Player's " + playerUnit3.unitName + " used Whirling Tornado on the enemy " + chosenEnemy3.unitName + " dealing " + whirlingTornadoBuff + " damage";
    ...
    public void PU1WindMove3Btn()
    {
        ...
        if (playerUnit1.isStunned == false)
        {
            ...
            if (chosenEnemy1.isBlocking == false)
            {
                ...
                if (playerUnit1.isBlocking == false && selfDamage == false)
                {
                    dialogueText.text = "Player's " + playerUnit1.unitName + " used Unstable Squall on the enemy " + chosenEnemy1.unitName + " dealing 20 damage";
                }
                else if (playerUnit1.isBlocking == false && selfDamage == true)
                {
                    dialogueText.text = "Player's " + playerUnit1.unitName + " used Unstable Squall on the enemy " + chosenEnemy1.unitName + " dealing 20 damage and receiving 20 recoil damage";
                }
                else if (playerUnit1.isBlocking == true && selfDamage == true)
                {
                    dialogueText.text = "Player's " + playerUnit1.unitName + " used Unstable Squall on the enemy " + chosenEnemy1.unitName + " dealing 20 damage and blocked the recoil damage";
                }
            ...
            else if (chosenEnemy1.isBlocking == true)
            {
                ...
                if (selfDamage == true)
                {
                    dialogueText.text = "Enemy " + chosenEnemy1.unitName + " blocked the attack but player's " + playerUnit1.unitName + " received 20 recoil damage";
                }
    ...
    public void PU2WindMove3Btn()
    {
        ...
        if (playerUnit2.isStunned == false)
        {
            ...
            if (chosenEnemy2.isBlocking == false)
            {
                ...
                if (playerUnit2.isBlocking == false && selfDamage == true)
                {
                    playerUnit2.TakeDamage(20);
                }
                ...
                if (playerUnit2.isBlocking == false && selfDamage == false)
                {
                    dialogueText.text = "Player's " + playerUnit2.unitName + " used Unstable Squall on the enemy " + chosenEnemy2.unitName + " dealing 20 damage";
                }
                else if (playerUnit2.isBlocking == false && selfDamage == true)
                {
                    dialogueText.text = "Player's " + playerUnit2.unitName + " used Unstable Squall on the enemy " + chosenEnemy2.unitName + " dealing 20 damage and receiving 20 recoil damage";
                }
                else if (playerUnit1.isBlocking == true && selfDamage == true)
                {
                    dialogueText.text = "Player's " + playerUnit2.unitName + " used Unstable Squall on the enemy " + chosenEnemy2.unitName + " dealing 20 damage and blocked the recoil damage";
                }
            ...
            else if (chosenEnemy2.isBlocking == true)
            {
                ...
                if (selfDamage == true)
                {
                    dialogueText.text = "Enemy " + chosenEnemy2.unitName + " blocked the attack but player's " + playerUnit2.unitName + " received 20 recoil damage";
                }
                else if (selfDamage == false)
                {
                    dialogueText.text = "Enemy " + chosenEnemy2.unitName + " blocked the attack";
    ...
    public void PU3WindMove3Btn()
    {
        ...
        if (playerUnit3.isStunned == false)
        {
            ...
            if (chosenEnemy3.isBlocking == false)
            {
                ...
                if (playerUnit3.isBlocking == false && selfDamage == true)
                {
                    playerUnit3.TakeDamage(20);
                }
                ...
                if (playerUnit3.isBlocking == false && selfDamage == false)
                {
                    dialogueText.text = "Player's " + playerUnit3.unitName + " used Unstable Squall on the enemy " + chosenEnemy3.unitName + " dealing 20 damage";
                }
                else if (playerUnit3.isBlocking == false && selfDamage == true)
                {
                    dialogueText.text = "Player's " + playerUnit3.unitName + " used Unstable Squall on the enemy " + chosenEnemy3.unitName + " dealing 20 damage and receiving 20 recoil damage";
                }
                else if (playerUnit3.isBlocking == true && selfDamage == true)
                {
                    dialogueText.text = "Player's " + playerUnit3.unitName + " used Unstable Squall on the enemy " + chosenEnemy3.unitName + " dealing 20 damage and blocked the recoil damage";
                }
            ...
            else if (chosenEnemy3.isBlocking == true)
            {
                ...
                if (selfDamage == true)
                {
                    dialogueText.text = "Enemy " + chosenEnemy3.unitName + " blocked the attack but player's " + playerUnit3.unitName + " received 20 recoil damage";
                }
                else if (selfDamage == false)
                {
                    dialogueText.text = "Enemy " + chosenEnemy3.unitName + " blocked the attack";
    ...
    public void PU1WindMove4Btn()
    {
        if (playerUnit1.isStunned == false)
        {
            ...
            dialogueText.text = "Player's " + playerUnit1.unitName + " used their buff increasing Hurricane Tailwind speed by 2";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit1.unitName + " is stunned";
    ...
    public void PU2WindMove4Btn()
    {
        if (playerUnit2.isStunned == false)
        {
            ...
            dialogueText.text = "Player's " + playerUnit2.unitName + " used their buff increasing Hurricane Tailwind speed by 2";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit2.unitName + " is stunned";
    ...
    public void PU3WindMove4Btn()
    {
        if (playerUnit3.isStunned == false)
        {
            ...
            dialogueText.text = "Player's " + playerUnit3.unitName + " used their buff increasing Hurricane Tailwind speed by 2";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit3.unitName + " is stunned";
