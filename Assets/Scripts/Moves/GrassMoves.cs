...
public class GrassMoves : MonoBehaviour
{
    ...
    public void PU1GrassMove2Btn()
    {
        ...
        if (playerUnit1.isStunned == false)
        {
            ...
            if (chosenEnemy1.isBlocking == false)
            {
                ...
                dialogueText.text = "Player's " + playerUnit1.unitName + " used Dark Osmosis on the enemy " + chosenEnemy1.unitName + " dealing 15 damage and absorbing 10 health";
    ...
    public void PU2GrassMove2Btn()
    {
        ...
        if (playerUnit2.isStunned == false)
        {
            ...
            if (chosenEnemy2.isBlocking == false)
            {
                chosenEnemy2.TakeDamage(15);
                playerUnit2.HealDamage(10);
                ...
                dialogueText.text = "Player's " + playerUnit2.unitName + " used Dark Osmosis on the enemy " + chosenEnemy2.unitName + " dealing 15 damage and absorbing 10 health";
        ...
        if (playerUnit3.isStunned == false)
        {
            ...
            if (chosenEnemy3.isDead == true)
            {
                for (int i = 0; i < 100; i++)
                {
                    ...
                    if (num == 0 && enemyUnit3.isDead == false)
                    {
                        chosenEnemy3 = enemyUnit1;
                        chosenEnemyHUD3 = enemyHUD1;
                        i = 101;
            ...
            if (chosenEnemy3.isBlocking == false)
            {
                ...
                chosenEnemy3.TakeDamage(15);
                playerUnit3.HealDamage(10);
                ...
                dialogueText.text = "Player's " + playerUnit3.unitName + " used Dark Osmosis on the enemy " + chosenEnemy3.unitName + " dealing 15 damage and absorbing 10 health";
    ...
    //p2 move 3
    public void PU2GrassMove3Btn()
    {
        if (playerUnit2.isStunned == false)
        {
            playerMove3CD = 5;

            playerUnit2.HealDamage(40);
            ...
            dialogueText.text = "Player's " + playerUnit2.unitName + " used Photosynthesis healing 40 health";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit2.unitName + " is stunned";
    ...
    //p3 move 3
    public void PU3GrassMove3Btn()
    {
        if (playerUnit3.isStunned == false)
        {
            playerMove3CD = 5;

            playerUnit3.HealDamage(40);
            ...
            dialogueText.text = "Player's " + playerUnit3.unitName + " used Photosynthesis healing 40 health";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit3.unitName + " is stunned";
    ...
    public void PU2GrassMove4Btn()
    {
        if (playerUnit2.isStunned == false)
        {
            ...
            dialogueText.text = "Player's " + playerUnit2.unitName + " used their buff increasing twisted roots slow by 2";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit2.unitName + " is stunned";
    ...
    public void PU3GrassMove4Btn()
    {
        if (playerUnit3.isStunned == false)
        {
            ...
            dialogueText.text = "Player's " + playerUnit3.unitName + " used their buff increasing twisted roots slow by 2";
        }
        else
        {
            dialogueText.text = "Player's " + playerUnit3.unitName + " is stunned";
